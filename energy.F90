...
! ... select appropriate external potential
   ...
   do ipt = 1, npt
      ...
      else if (txuext(ipt) == 'cylinder_shell') then
         call UExternalCylShell
...
subroutine UExternalCylShell        ! hard spherical capsid shell
   character(40), parameter :: txroutine ='UExternalCylShell'
!print*,'¤¤¤¤¤¤¤¤¤  In UExternalCylShell  ¤¤¤¤¤¤¤'
!print*,'rcap, dcap, half*lcap', rcap, dcap, half*lcap
!print*,'inner and outer limits', (rcap-radat(ipt))**2, (rcap+dcap+radat(ipt))**2
!print*,'ipt', ipt
   do ia=ialow,iaupp
!print*,'ia', ia
      r2=r(1,ia)**2+r(2,ia)**2
!print*,'x, y, z', r(1,ia), r(2,ia), r(3,ia)
!print*,'r2', r2
      if ((r(3,ia)+radat(ipt)) >= half*lcap .or. (r(3,ia)-radat(ipt)) <=-half*lcap) cycle
!print*,'within the z coordinate'
      if (r2>=(rcap-radat(ipt))**2 .and. r2<=(rcap+dcap+radat(ipt))**2) &
         call Stop(txroutine, 'hard-core overlap with cylinder shell', uout)
!print*,'=========='
   end do
end subroutine UExternalCylShell
