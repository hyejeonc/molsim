      ...
      if (master) then
         ...
         do ipt = 1, npt
            ...
            if (txuext(ipt) == 'wall_z') then
               ...
               write(uout,'(a)') 'hard wall between rcap and rcap+dcap'
               write(uout,'(a,t35,3g10.3)') 'cylinder radius                = ', rcap
               write(uout,'(a,t35,3g10.3)') 'cylinder radius + thickness    = ', rcap+dcap
               write(uout,'(a,t35,3g10.3)') 'length of the cylinder shell   = ', lcap
